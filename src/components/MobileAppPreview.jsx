...
export default function MobileAppPreview() {
  ...
  return (
    <div id="mobile-app" className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black py-12 sm:py-16 md:py-20 px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-6 sm:space-y-8 px-4 lg:px-0 mt-8 lg:mt-0">
            ...
            <div className="pt-4 sm:pt-6 md:pt-8">
              <button className="w-full bg-green-600 text-white py-3 sm:py-4 px-6 rounded-lg sm:rounded-xl text-sm sm:text-base font-semibold transition flex items-center justify-center gap-2 sm:gap-3 group hover:bg-green-700 active:scale-95">
